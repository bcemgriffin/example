	    	...
	    	<div id='printMe'>
	    		<div class="contentgrid">
     				...
     				<div class="content1p">
			  		...
			  		<div class="content2">
						<img src="http://mysql.griffin.local:8080/MyWebsite/images/${recipe.getPhotoName()}" style="height:320px" alt="Image Not Uploaded - ${catalinabase}/images/${recipe.getPhotoName()}" />
			  		</div>
